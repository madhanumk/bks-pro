...
const Sidebar = () => {
    ...
    return (
        <div className={semidark ? 'dark' : ''}>
            <nav
                className={`sidebar small-device fixed top-0 bottom-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300 ${semidark ? 'text-white-dark' : ''}`}
            >
