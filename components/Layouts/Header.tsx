        ...
        confirm({
            ...
            onOk() {
                ...
                if (!Token) {
                    ...
                    // Add your logic here, e.g., router.push("/auth/login");
                } else {
                    // Proceed with the request
                    axios.get("http://files.covaiciviltechlab.com/logout/", {
                        headers: {
    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black header-main">
                ...
                {/* horizontal menu */}
                <ul className="horizontal-menu flex border-t border-[#ebedf2] bg-white py-1.5 px-6 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-black dark:text-white-dark lg:space-x-1.5 xl:space-x-8 system-navbar">
